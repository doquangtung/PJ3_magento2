...
namespace Bss\LensSystem\Model\ResourceModel\LensOptions;
...
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(\Bss\LensSystem\Model\LensOptions::class, \Bss\LensSystem\Model\ResourceModel\LensOptions::class);
    }
