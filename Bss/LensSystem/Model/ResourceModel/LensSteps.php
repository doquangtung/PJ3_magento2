...
/**
 * LensSteps Class
 * Resource Model Steps
 */
class LensSteps extends AbstractEntity
{
    /**
     * Store id
     *
    ...
    public function __construct(
        ...
        $this->setType(LensStepsSetup::ENTITY_TYPE_CODE);
        $this->setConnection(LensStepsSetup::ENTITY_TYPE_CODE . '_read');
