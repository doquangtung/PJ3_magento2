...
/**
 * Step Colelction Class
 * Resource Model for Attribute Steps
 */
class StepsCollection extends EavCollection
{
    /**
     * Entity factory
     *
    ...
    protected function _initSelect()
    {
        $this->getSelect()->from(
            ...
            $this->eavEntityFactory->create()->setType(LensStepsSetup::ENTITY_TYPE_CODE)->getTypeId()
        )->join(
            ['additional_table' => $this->getTable(LensStepsSetup::EAV_ENTITY_TYPE_CODE . '_eav_attribute')],
