...
/**
 * Class LensOptionsActions
 * Actions for Lens Options
 */
class LensOptionsActions extends Column
{
    /**
     * Url path
     */
    ...
    const URL_PATH_DELETE = 'lenssystem/options/delete';
                ...
                if (isset($item['entity_id'])) {
                    $item[$this->getData('name')]['edit'] = [
                        'href' => $this->urlBuilder->getUrl(
                            self::URL_PATH_EDIT,
                            ['entity_id' => $item['entity_id'], 'store' => 0]
                        ),
                        'label' => __('Edit'),
                        'hidden' => false,
                    ];
